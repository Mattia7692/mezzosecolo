  ...
  const mapsSection = mapsUrl
    ? `
      <div style="margin: 24px 0; border-radius: 8px; overflow: hidden; border: 1px solid #e8e0d0;">
        <a href="${mapsUrl}" style="display:block; text-decoration:none;">
          <img src="${baseUrl}/mappa.jpg" alt="Mappa - Via privata Solone 9, Milano" width="100%" style="display:block; border:0; max-width:100%;" />
          <div style="background:#2d2d4e; color:#c9a84c; text-align:center; padding:10px; font-size:13px; font-family:Arial,sans-serif;">
            📍 Apri in Google Maps →
          </div>
        </a>
      </div>
